                                                                  ...
                                                                  list(
                                                                    ...
                                                                    conditionalPanel(condition = "input.color_opt9",
                                                                                     conditionalPanel(condition="input.plot_type9 == 'point' | input.plot_type9 == 'line' | input.plot_type9 == 'bar' | input.plot_type9 == 'segment'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.col_type9=='2'",
                                                                                                                       fluidRow(column(12, colourInput("color_cus9", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type9=='rect_discrete'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.rect_col9=='2'",
                                                                                                                       fluidRow(column(12, colourInput("rect_col_dis9", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type9=='rect_gradual'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.rect_grad_col9=='2'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(6, colourInput("rect_2cols_low9", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("rect_2cols_high9", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      ),
                                                                                                      conditionalPanel(condition="input.rect_grad_col9=='3'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(4, colourInput("rect_3cols_low9", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_mid9", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_high9", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type9=='heatmap_gradual'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col9=='2'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(6, colourInput("hmap_2cols_low9", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("hmap_2cols_high9", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),																											  
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col9=='3'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(4, colourInput("hmap_3cols_low9", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_mid9", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_high9", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      )	
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type9=='vertical_line' | input.plot_type9=='horizontal_line'",
                                                                                                      fluidRow(column(12, colourInput("line_color9", label = h5('Line color:',
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type9=='line'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.fill_area9=='1'",
                                                                                                                       ...
                                                                                                                       conditionalPanel(condition = "input.sel_area_type9=='2'",
                                                                                                                                        fluidRow(column(12, colourInput("border_area9", label = NULL, value = "#0000FF", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                                        br()
                                                                                                                       )
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type9=='point' | input.plot_type9=='line' | input.plot_type9=='bar' | input.plot_type9=='rect_gradual' | input.plot_type9=='rect_discrete' | input.plot_type9=='heatmap_gradual' | input.plot_type9=='heatmap_discrete' | input.plot_type9=='vertical_line' | input.plot_type9=='horizontal_line' | input.plot_type9=='text' | input.plot_type9 == 'segment'",
                                                                                                      conditionalPanel(condition="input.plot_type9=='text'",
                                                                                                                       fluidRow(column(12, colourInput("text_col9", label = HTML('<p><font size="3.0"><strong>Font color:</strong></font></p>'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                    ...
                                                                    conditionalPanel(condition = "input.plot_type9=='heatmap_gradual' | input.plot_type9=='heatmap_discrete' | input.plot_type9=='rect_gradual' | input.plot_type9=='rect_discrete' | input.plot_type9=='bar'",
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.add_border9=='1'",
                                                                                                      fluidRow(column(12, colourInput("border_col9", label = h5('Borders color:'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                      br()
                                                                                     )
                                                                    ),
