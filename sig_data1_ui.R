...
sig_data1 <- conditionalPanel(condition = "input.data1",
                              radioButtons("sel_upload_data1", NULL, c("Disable data input" = "1", "Upload input data" = "2"), "1"),
                              conditionalPanel(condition = "input.sel_upload_data1 == '2'",
                                               selectInput("layer_index1", tags$div(HTML('<i class="fa fa-play" aria-hidden="true"></i> <font size="3" color="red"><b>Track index:</b></font>'),
                                               ...
                                               selectInput("plot_type1", tags$div(HTML('<i class="fa fa-play" aria-hidden="true"></i> <font size="3" color="red"><b>Plot type:</b></font>')), 
                                                                  ...
                                                                  list(
                                                                    ...
                                                                    conditionalPanel(condition = "input.color_opt1",
                                                                                     conditionalPanel(condition = "input.plot_type1 == 'point' | input.plot_type1 == 'line' | input.plot_type1 == 'bar' | input.plot_type1 == 'segment'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.col_type1 == '2'",
                                                                                                                       fluidRow(column(12, colourInput("color_cus1", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type1=='rect_discrete'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.rect_col1=='2'",
                                                                                                                       fluidRow(column(12, colourInput("rect_col_dis1", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type1=='rect_gradual'",
                                                                                                      ...
                                                                                                      bsPopover("bsb8", "Colors to be used for the data, which can be assigned by the application or be specified by the users. By default, predefined color would be used.",
                                                                                                                trigger = "focus"),
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.rect_grad_col1=='2'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(6, colourInput("rect_2cols_low1", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("rect_2cols_high1", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      ),
                                                                                                      conditionalPanel(condition="input.rect_grad_col1=='3'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(4, colourInput("rect_3cols_low1", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_mid1", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_high1", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type1=='heatmap_gradual'",
                                                                                                      ...
                                                                                                      bsPopover("bsb9",
                                                                                                                "Colors to be used for the data, which can be assigned by the application or be specified by the users. By default, predefined color would be used.",
                                                                                                                trigger = "focus"),
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col1=='2'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(6, colourInput("hmap_2cols_low1", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("hmap_2cols_high1", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),																											  
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col1=='3'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(4, colourInput("hmap_3cols_low1", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_mid1", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_high1", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition="input.plot_type1=='vertical_line' | input.plot_type1=='horizontal_line'",
                                                                                                      fluidRow(column(12, colourInput("line_color1", label = h5("Line color:", bsButton("bsb11", label="", icon=icon("question"), style="info", size="small")
                                                                                     ...
                                                                                     conditionalPanel(condition="input.plot_type1=='line'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.fill_area1=='1'",
                                                                                                                       ...
                                                                                                                       conditionalPanel(condition = "input.sel_area_type1=='2'",
                                                                                                                                        fluidRow(column(12, colourInput("border_area1", label = NULL, value = "#0000FF", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                                        br()
                                                                                                                       )
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type1=='point' | input.plot_type1=='line' | input.plot_type1=='bar' | input.plot_type1=='rect_gradual' | input.plot_type1=='rect_discrete' | input.plot_type1=='heatmap_gradual' | input.plot_type1=='heatmap_discrete' | input.plot_type1=='vertical_line' | input.plot_type1=='horizontal_line' | input.plot_type1=='text' | input.plot_type1 == 'segment'",
                                                                                                      conditionalPanel(condition="input.plot_type1=='text'",
                                                                                                                       fluidRow(column(12, colourInput("text_col1", label = HTML('<p><font size="3.0"><strong>Font color:</strong></font></p>'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                    ...
                                                                    conditionalPanel(condition = "input.plot_type1=='heatmap_gradual' | input.plot_type1=='heatmap_discrete' | input.plot_type1=='rect_gradual' | input.plot_type1=='rect_discrete' | input.plot_type1=='bar'",
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.add_border1=='1'",
                                                                                                      fluidRow(column(12, colourInput("border_col1", label = h5('Borders color:'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                      br()
                                                                                     )
                                                                    ),
