...
cat(paste('data.T.file <- c("',paste(uploadfile.export,collapse ='","'),'")',sep=""),file="code.R",append=TRUE,sep="\n")
  ...
  cat("data.T <- lapply(1:10,function(x){
			 if(seluploaddata[x] == 2 && nchar(data.T.file[x])>0){	  
...
paste('colrect <- c("',paste(colrect,collapse='","'),'")',sep=""),paste("heatmapcol <- c(",paste(heatmapcol,collapse=','),")",sep=""),paste('colhmap <- c("',paste(colhmap,collapse='","'),'")',sep=""),
...
paste("symbolpoint <- c(",paste(symbolpoint,collapse=','),")",sep=""),paste("pointsize <- c(",paste(pointsize,collapse=','),")",sep=""),paste('linecolor <- c("',paste(linecolor,collapse='","'),'")',sep=""),
...
paste('borderarea <- c("',paste(borderarea,collapse='","'),'")',sep=""),paste("xrugs <- c(",paste(xrugs,collapse=','),")",sep=""),paste("yrugs <- c(",paste(yrugs,collapse=','),")",sep=""),
paste('xrugscol <- c("',paste(xrugscol,collapse='","'),'")',sep=""),paste('yrugscol <- c("',paste(yrugscol,collapse='","'),'")',sep=""),paste('linetype <- c("',paste(linetype,collapse='","'),'")',sep=""),
paste('addarrow <- c(',paste(addarrow,collapse=','),')',sep=""),paste('arrowpos <- c(',paste(arrowpos,collapse=','),')',sep=""),paste('arrowsize <- c(',paste(arrowsize,collapse=','),')',sep=""),
paste('textcol <- c("',paste(textcol,collapse='","'),'")',sep=""),paste("textsize <- c(",paste(textsize,collapse=','),")",sep=""),paste('fontface <- c("',paste(fontface,collapse='","'),'")',sep=""),
paste("textangle <- c(",paste(textangle,collapse=','),")",sep=""),paste("addlegend <- c(",paste(addlegend,collapse=','),")",sep=""),paste("collgd <- c(",paste(collgd,collapse=','),")",sep=""),paste('collgdname <- c("',paste(collgdname,collapse='","'),'")',sep=""),
...
cat('names(data.C) <- c("chr","size")
	  ...
	  for(i in indx){	  
		 ...
		 #### color
		  ...
		  if(plottype[i] %in% "rect_discrete"){
		      ...
		      if(selrectcol==1){
                  ...
                  rectcols <- gsub("\\\\s","",strsplit(rectcols,",")[[1]])',paste('rectcols <- gsub(',"'","\\\\",'"',"'",',"",rectcols)',sep=""),
         ...
         if(plottype[i] %in% "heatmap_gradual"){
		     if(heatmapcol[i]==1){',paste('hmapcols <- gsub(',"'","\\\\",'"',"'",',"",colhmap[i])',sep=""),
			 '}else{
         ...
         if(plottype[i] %in% c("vertical line","horizontal line")){
             ...
             linecolorp <- gsub("\\\\s","",strsplit(linecolorp,",")[[1]])[1]',paste('linecolorp <- gsub(',"'","\\\\",'"',"'",',"",linecolorp)',sep=""),
		 ...
		 if(addlegend[i]==1){
		   if(collgd[i]==1){
			  ...
			  if(collgdmdylabel[i]==1){
                  collgdlabelp <- gsub("\\\\s","",strsplit(collgdlabel[i],",")[[1]])',paste('collgdlabelp <- gsub(',"'","\\\\",'"',"'",',"",collgdlabelp)',sep=""),
		   ...
		   if(sizelgd[i]==1){
			 ...
			 if(sizelgdmdylabel[i]==1){
                 sizelgdlabelp <- gsub("\\\\s","",strsplit(sizelgdlabel[i],",")[[1]])',paste('sizelgdlabelp <- gsub(',"'","\\\\",'"',"'",',"",sizelgdlabelp)',sep=""),
		   ...
		   if(shapelgd[i]==1){
			 ...
			 if(shapelgdmdylabel[i]==1){
                 shapelgdlabelp <- gsub("\\\\s","",strsplit(shapelgdlabel[i],",")[[1]])',paste('shapelgdlabelp <- gsub(',"'","\\\\",'"',"'",',"",shapelgdlabelp)',sep=""),
		   ...
		   if(linetypelgd[i]==1){
			 ...
			 if(linetypelgdmdylabel[i]==1){
                 linetypelgdlabelp <- gsub("\\\\s","",strsplit(linetypelgdlabel[i],",")[[1]])',paste('linetypelgdlabelp <- gsub(',"'","\\\\",'"',"'",',"",linetypelgdlabelp)',sep=""),
