...
sig_data4 <- conditionalPanel(condition = "input.data4",
                              radioButtons("sel_upload_data4", NULL, c("Disable data input" = "1", "Upload input data" = "2"), "1"),
                              conditionalPanel(condition = "input.sel_upload_data4 == '2'",
                                               selectInput("layer_index4", tags$div(HTML('<i class="fa fa-play" aria-hidden="true"></i> <font size="3" color="red"><b>Track index:</b></font>'),
                                               ...
                                               selectInput("plot_type4", tags$div(HTML('<i class="fa fa-play" aria-hidden="true"></i> <font size="3" color="red"><b>Plot type:</b></font>')), 
                                                                  ...
                                                                  list(
                                                                    ...
                                                                    conditionalPanel(condition = "input.color_opt4",
                                                                                     conditionalPanel(condition="input.plot_type4 == 'point' | input.plot_type4 == 'line' | input.plot_type4 == 'bar' | input.plot_type4 == 'segment'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.col_type4=='2'",
                                                                                                                       fluidRow(column(12, colourInput("color_cus4", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type4=='rect_discrete'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.rect_col4=='2'",
                                                                                                                       fluidRow(column(12, colourInput("rect_col_dis4", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type4=='rect_gradual'",
                                                                                                      ...
                                                                                                      bsPopover("bsb104", "Colors to be used for the data, which can be assigned by the application or be specified by the users. By default, predefined color would be used.", trigger = "focus"),
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.rect_grad_col4=='2'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(6, colourInput("rect_2cols_low4", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("rect_2cols_high4", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      ),
                                                                                                      conditionalPanel(condition="input.rect_grad_col4=='3'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(4, colourInput("rect_3cols_low4", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_mid4", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_high4", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      )		
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type4=='heatmap_gradual'",
                                                                                                      ...
                                                                                                      bsPopover("bsb105", "Colors to be used for the heatmap, which can be assigned by the application or be specified by the users. By default, predefined color would be used.", trigger = "focus"),
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col4=='2'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(6, colourInput("hmap_2cols_low4", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("hmap_2cols_high4", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),																											  
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col4=='3'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(4, colourInput("hmap_3cols_low4", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_mid4", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_high4", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      )			
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type4=='vertical_line' | input.plot_type4=='horizontal_line'",
                                                                                                      fluidRow(column(12, colourInput("line_color4", label = h5('Line color:',
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type4=='line'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.fill_area4=='1'",
                                                                                                                       ...
                                                                                                                       conditionalPanel(condition = "input.sel_area_type4=='2'",
                                                                                                                                        fluidRow(column(12, colourInput("border_area4", label = NULL, value = "#0000FF", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                                        br()
                                                                                                                       )
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type4=='point' | input.plot_type4=='line' | input.plot_type4=='bar' | input.plot_type4=='rect_gradual' | input.plot_type4=='rect_discrete' | input.plot_type4=='heatmap_gradual' | input.plot_type4=='heatmap_discrete' | input.plot_type4=='vertical_line' | input.plot_type4=='horizontal_line' | input.plot_type4=='text' | input.plot_type4 == 'segment'",
                                                                                                      conditionalPanel(condition="input.plot_type4=='text'",
                                                                                                                       fluidRow(column(12, colourInput("text_col4", label = HTML('<p><font size="3.0"><strong>Font color:</strong></font></p>'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                    ...
                                                                    conditionalPanel(condition = "input.plot_type4=='heatmap_gradual' | input.plot_type4=='heatmap_discrete' | input.plot_type4=='rect_gradual' | input.plot_type4=='rect_discrete' | input.plot_type4=='bar'",
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.add_border4=='1'",
                                                                                                      fluidRow(column(12, colourInput("border_col4", label = h5('Borders color:'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                      br()
                                                                                     )
                                                                    ),
