                                                                  ...
                                                                  list(
                                                                    ...
                                                                    conditionalPanel(condition = "input.color_opt6",
                                                                                     conditionalPanel(condition="input.plot_type6 == 'point' | input.plot_type6 == 'line' | input.plot_type6 == 'bar' | input.plot_type6 == 'segment'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.col_type6=='2'",
                                                                                                                       fluidRow(column(12, colourInput("color_cus6", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type6=='rect_discrete'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.rect_col6=='2'",
                                                                                                                       fluidRow(column(12, colourInput("rect_col_dis6", label = NULL, value = "#FF0000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type6=='rect_gradual'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.rect_grad_col6=='2'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(6, colourInput("rect_2cols_low6", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("rect_2cols_high6", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      ),
                                                                                                      conditionalPanel(condition="input.rect_grad_col6=='3'",
                                                                                                                       fluidRow(			                                                         
                                                                                                                         column(4, colourInput("rect_3cols_low6", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_mid6", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("rect_3cols_high6", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))), 
                                                                                                                       br()
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type6=='heatmap_gradual'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col6=='2'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(6, colourInput("hmap_2cols_low6", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(6, colourInput("hmap_2cols_high6", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),																											  
                                                                                                      conditionalPanel(condition="input.sel_heatmap_col6=='3'",
                                                                                                                       fluidRow(			                                        
                                                                                                                         column(4, colourInput("hmap_3cols_low6", label = HTML('<p><font size="2.0"><strong>Low Color</strong></font></p>'), value = "#0016DB", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_mid6", label = HTML('<p><font size="2.0"><strong>Middle Color</strong></font></p>'), value = "#FFFFFF", returnName = TRUE, allowTransparent = TRUE)), 
                                                                                                                         column(4, colourInput("hmap_3cols_high6", label = HTML('<p><font size="2.0"><strong>High Color</strong></font></p>'), value = "#FFFF00", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      )	
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type6=='vertical_line' | input.plot_type6=='horizontal_line'",
                                                                                                      fluidRow(column(12, colourInput("line_color6", label = h5('Line color:',
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type6=='line'",
                                                                                                      ...
                                                                                                      conditionalPanel(condition = "input.fill_area6=='1'",
                                                                                                                       ...
                                                                                                                       conditionalPanel(condition = "input.sel_area_type6=='2'",
                                                                                                                                        fluidRow(column(12, colourInput("border_area6", label = NULL, value = "#0000FF", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                                        br()
                                                                                                                       )
                                                                                                      )
                                                                                     ),
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.plot_type6=='point' | input.plot_type6=='line' | input.plot_type6=='bar' | input.plot_type6=='rect_gradual' | input.plot_type6=='rect_discrete' | input.plot_type6=='heatmap_gradual' | input.plot_type6=='heatmap_discrete' | input.plot_type6=='vertical_line' | input.plot_type6=='horizontal_line' | input.plot_type6=='text' | input.plot_type6 == 'segment'",
                                                                                                      conditionalPanel(condition="input.plot_type6=='text'",
                                                                                                                       fluidRow(column(12, colourInput("text_col6", label = HTML('<p><font size="3.0"><strong>Font color:</strong></font></p>'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                                       br()
                                                                                                      ),
                                                                    ...
                                                                    conditionalPanel(condition = "input.plot_type6=='heatmap_gradual' | input.plot_type6=='heatmap_discrete' | input.plot_type6=='rect_gradual' | input.plot_type6=='rect_discrete' | input.plot_type6=='bar'",
                                                                                     ...
                                                                                     conditionalPanel(condition = "input.add_border6=='1'",
                                                                                                      fluidRow(column(12, colourInput("border_col6", label = h5('Borders color:'), value = "#000000", returnName = TRUE, allowTransparent = TRUE))),
                                                                                                      br()
                                                                                     )
                                                                    ),
