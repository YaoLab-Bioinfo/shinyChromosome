...
two_genomes_plot <- function(data.C1,data.C2,data.TC,Height,Width,themestyle,fontSize,xtitle,ytitle,titlefontface,xlabel,ylabel,legendpos,lgdtitlesize,lgdtitlefontface,lgdtextsize,lgdtextfontface,tc_chrdata1,
