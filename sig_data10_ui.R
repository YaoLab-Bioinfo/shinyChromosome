...
sig_data10 <- conditionalPanel(condition="input.data10",
                               radioButtons("sel_upload_data10", NULL, c("Disable data input" = "1", "Upload input data" = "2"), "1"),
                               conditionalPanel(condition="input.sel_upload_data10 == '2'",
                                                selectInput("layer_index10", tags$div(HTML('<i class="fa fa-play" aria-hidden="true"></i> <font size="3" color="red"><b>Track index:</b></font>'),
                                                ...
                                                selectInput("plot_type10", tags$div(HTML('<i class="fa fa-play" aria-hidden="true"></i> <font size="3" color="red"><b>Plot type:</b></font>')),
                                                                   ...
                                                                   list(
                                                                     ...
                                                                     conditionalPanel(condition = "input.color_opt10",
                                                                                      ...
                                                                                      conditionalPanel(condition = "input.plot_type10=='rect_gradual'",
                                                                                                       ...
                                                                                                       bsPopover("bsb294", "Colors to be used for the data, which can be assigned by the application or be specified by the users. By default, predefined color would be used.", trigger = "focus"),
                                                                                      ...
                                                                                      conditionalPanel(condition = "input.plot_type10=='heatmap_gradual'",
                                                                                                       ...
                                                                                                       bsPopover("bsb295", "Colors to be used for the heatmap, which can be assigned by the application or be specified by the users. By default, predefined color would be used.", trigger = "focus"),
